...
export default function OrderPage() {
  ...
  const [order, setOrder] = useState({
    date: formattedDate,
    orderNumber: `ORD-${today.getFullYear()}${String(today.getMonth() + 1).padStart(2, '0')}${String(today.getDate()).padStart(2, '0')}-${Math.floor(Math.random() * 1000).toString().padStart(3, '0')}`,
    supplierName: '',
    supplierAddress: '',
    deliveryLocation: '平田トレーディング本社倉庫',
    requestedDeliveryDate: '',
    paymentMethod: '銀行振込',
    items: Array(10).fill().map(() => ({
      productName: '',
      productCode: '',
      quantity: 0,
      unit: '個',
  ...
  const generatePDF = () => {
    ...
    // For this template, we'll simulate a delay and then return a mock PDF URL
    setTimeout(() => {
      setLoading(false);
      setPdfUrl('#'); // In a real app, this would be the URL to the generated PDF
      alert('発注書PDFが生成されました。実際のアプリケーションでは、PDFがダウンロードされます。');
    }, 1500);
  };
            ...
            <div className="px-4 py-5 sm:p-6">
              <form>
                <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) => setOrder({ ...order, supplierName: e.target.value })}
                        className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                      />
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-3">
                    <label htmlFor="supplierAddress" className="block text-sm font-medium text-gray-700">
                      サプライヤー住所
                    </label>
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) => setOrder({ ...order, supplierAddress: e.target.value })}
                        className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                      />
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) => setOrder({ ...order, deliveryLocation: e.target.value })}
                        className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                      />
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) => setOrder({ ...order, requestedDeliveryDate: e.target.value })}
                  ...
                  <div className="sm:col-span-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">発注商品</h3>
